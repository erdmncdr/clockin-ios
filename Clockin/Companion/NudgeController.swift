        ...
        while processed != revision {
            ...
            for nudge in plan {
                ...
                if existing[nudge.identifier] == nil && available == 0 {
                    errorMessage = String(localized: "No notification slots available. Reopen Clockin later to try again.", bundle: .app)
                    continue
                }
                ...
                do {
                    ...
                    guard processed == revision else { break }
                    errorMessage = String(localized: "Could not schedule nudges: \(error.localizedDescription)", bundle: .app)
                }
            }
        }
    }
