            ...
            if let event = center.event, !event.isReaction {
                ...
                Group {
                    ...
                    case .wardrobe(let name, let introductory):
                        banner(title: name, icon: "tshirt.fill", wardrobeTitle: introductory ? String(localized: "Wardrobe unlocked", bundle: .app) : String(localized: "New item", bundle: .app))
                    case .moreBadges(let ids):
                        banner(title: String(localized: "and \(ids.count) more", bundle: .app), icon: "rosette")
        ...
        Button {
            ...
            HStack(spacing: 12) {
                ...
                VStack(alignment: .leading, spacing: 3) {
                    Text(wardrobeTitle ?? (accessory == nil ? String(localized: "Badge unlocked", bundle: .app) : String(localized: "New accessory", bundle: .app))).font(.caption.weight(.semibold)).foregroundStyle(.secondary)
