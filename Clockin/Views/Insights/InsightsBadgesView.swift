                ...
                ForEach(items) { badge in
                    Button { selectedBadge = badge } label: {
                        VStack(spacing:3) {
                            ...
                            Text(badge.unlocked ? String(localized: "badge.status.earned", defaultValue: "Earned", bundle: .app) : String(localized: "Locked", bundle: .app))
                    ...
                    .accessibilityValue(badge.unlocked ? String(localized: "badge.status.earned", defaultValue: "Earned", bundle: .app) : badge.requirement)
                }
            }
            .id(tier)
        }
