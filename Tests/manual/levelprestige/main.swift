...
check(LevelPrestige(level: 600).isMilestone, "600 opens the last rank")
check(!LevelPrestige(level: 675).isMilestone && !LevelPrestige(level: 750).isMilestone, "no rank beat past the last rank")
